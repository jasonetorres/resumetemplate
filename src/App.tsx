        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <h1 className="text-lg sm:text-2xl font-bold text-white">Torc Resume & Cover Letter</h1>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button
                onClick={() => setShowGuidance(!showGuidance)}
                className="hidden sm:flex items-center space-x-2 px-4 sm:px-6 py-2 sm:py-3 text-white rounded-full hover:opacity-90 transition-all duration-200 font-medium text-sm sm:text-base"
              ...
              <button
                onClick={() => setShowGuidance(!showGuidance)}
                className="sm:hidden flex items-center px-3 py-2 text-white rounded-full hover:opacity-90 transition-all duration-200 font-medium text-sm"
                style={{ backgroundColor: '#0044ff' }}
              >
                <Info className="w-4 h-4" />
              </button>
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-1 sm:space-x-2 px-3 sm:px-6 py-2 sm:py-3 text-white rounded-full hover:opacity-90 transition-all duration-200 font-medium text-sm sm:text-base"
                  style={{ backgroundColor: '#0044ff' }}
                >
                ...
                {showExportMenu && (
                  <div className="absolute right-0 mt-2 w-48 sm:w-56 bg-black rounded-2xl shadow-lg border border-white/20 z-50">
                    <div className="py-2">
                      <button
                        onClick={() => handleExportConfirm(executePrint, 'Print / Save as PDF')}
                        className="w-full text-left px-4 py-3 text-white hover:bg-white/10 flex items-center space-x-2 font-medium transition-colors duration-200 text-sm sm:text-base"
                      >
